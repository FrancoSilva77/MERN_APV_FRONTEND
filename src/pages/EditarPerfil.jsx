      ...
      <div className="flex justify-center">
        <div className="w-full md:w-1/2 shadow rounded-lg p-5">
          ...
          <form onSubmit={handleSubmit}>
            <div className="my-3">
              <label htmlFor="" className="uppercase fonto-bold text-gray-600">Nombre</label>
            ...
            <div className="my-3">
              <label htmlFor="" className="uppercase fonto-bold text-gray-600">Sitio web</label>
            ...
            <div className="my-3">
              <label htmlFor="" className="uppercase fonto-bold text-gray-600">Télefono</label>
            ...
            <div className="my-3">
              <label htmlFor="" className="uppercase fonto-bold text-gray-600">Email</label>
